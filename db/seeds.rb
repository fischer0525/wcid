...
np5 = User.create!(username: "veteransforveterans", email: "veteransforveterans@gmail.com", password: "password", password_confirmation: "password", contact_number: "215-555-5555", organization: "Veterans for Veterans", profile_photo: "http://67.225.129.146/~nextop/wp-content/uploads/2014/10/icon-vets-lrg.png")

event1 = Event.create!(user: np1, event_name: "Samuels Park Cleanup", event_date: "05/01/17", event_time: "9:00AM", address: "100 Green Street", city: "Philadelphia", state: "PA", zip: "19123", neighborhood: "NOrthern Liberties", description: "Neighborhood coming together to cleanup Samuels Park, includes trash collection, raking, and some gardening. Tools will be provided. Please wear close toed shoes and clothing that you are willing to get dirty.")
